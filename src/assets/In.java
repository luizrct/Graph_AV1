package assets; /******************************************************************************
 *  Compilation:  javac assets.In.java
 *  Execution:    java assets.In   (basic test --- see source for required files)
 *  Dependencies: none
 *
...
/**
 *  The <code>assets.In</code> data type provides methods for reading strings
...
public final class In {
    ...
    public In(File file) {
        ...
        try {
            // for consistency with assets.StdIn, wrap with BufferedInputStream instead of use
     ...
     * @deprecated Replaced by {@code new assets.In(filename)}.{@link #readAllInts()}.
     */
    @Deprecated
     ...
     * @deprecated Replaced by {@code new assets.In(filename)}.{@link #readAllDoubles()}.
     */
    @Deprecated
     ...
     * @deprecated Replaced by {@code new assets.In(filename)}.{@link #readAllStrings()}.
     */
    @Deprecated
     ...
     * @deprecated Replaced by {@code new assets.In()}.{@link #readAllInts()}.
     */
    @Deprecated
     ...
     * @deprecated Replaced by {@code new assets.In()}.{@link #readAllDoubles()}.
     */
    @Deprecated
     ...
     * @deprecated Replaced by {@code new assets.In()}.{@link #readAllStrings()}.
     */
    @Deprecated
    ...
    /**
     * Unit tests the {@code assets.In} data type.
     *

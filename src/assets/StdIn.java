package assets; /******************************************************************************
 *  Compilation:  javac assets.StdIn.java
 *  Execution:    java assets.StdIn   (interactive test of basic functionality)
 *  Dependencies: none
 *
...
/**
 *  The {@code assets.StdIn} class provides static methods for reading strings
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code assets.StdIn.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdIn.java">assets.StdIn.java</a>
 ...
 *  <pre>
 *  while (!assets.StdIn.isEmpty()) {
 *      double value = assets.StdIn.readDouble();
 *      assets.StdOut.println(value);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (assets.StdIn.hasNextChar()) {
 *      char c = assets.StdIn.readChar();
 *      assets.StdOut.print(c);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (assets.StdIn.hasNextLine()) {
 *      String line = assets.StdIn.readLine();
 *      assets.StdOut.println(line);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  String[] words = assets.StdIn.readAllStrings();
 *  </pre>
 *  <p>
 *  <b>Differences with Scanner.</b>
 *  {@code assets.StdIn} and {@link Scanner} are both designed to parse
 *  tokens and convert them to primitive types and strings.
 *  The main differences are summarized below:
 *  <ul>
 *  <li> {@code assets.StdIn} is a set of static methods and reads
 *       reads input from only standard input. It is suitable for use before
 *       a programmer knows about objects.
 *       Seect-oriented version that handles
 *       input from files, URLs,
 *       and sockets.
 *  <li> {@code assets.StdIn} uses whitespace as the delimiter pattern
 *       that separates tokens.
 *       {@link Scanner} supports arbitrary delimiter patterns.
 *  <li> {@code assets.StdIn} coerces the character-set encoding to UTF-8,
 *       which is the most widely used character encoding for Unicode.
 *  <li> {@code assets.StdIn} coerces the locale to {@link Locale#US},
 *       for consistency with {@link StdOut}, {@link Double#parseDouble(String)},
 *       and floating-point literals.
 *  <li> {@code assets.StdIn} has convenient methods for reading a single
 *       character; reading in sequences of integers, doubles, or strings;
 *       and reading in all of the remaining input.
 *  </ul>
 *  <p>
 *  Historical note: {@code assets.StdIn} preceded {@code Scanner}; when
 ...
 *  Windows, and Linux.
 *  The methods in {@code assets.StdIn} are <em>blocking</em>, which means that they
 ...
 *  If the input begins with the optional byte-order mask, {@code assets.StdIn}
...
public final class StdIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from assets.In to assets.StdIn. */
    ...
    /*** end: section (1 of 2) of code duplicated from assets.In to assets.StdIn. */
    ...
    //// begin: section (2 of 2) of code duplicated from assets.In to assets.StdIn,
    ...
    public static char readChar() {
        try {
            ...
            assert ch.length() == 1 : "Internal (Std)assets.In.readChar() error!"
    ...
    //// end: section (2 of 2) of code duplicated from assets.In to assets.StdIn

    // do this once when assets.StdIn is initialized
    static {
        resync();
    }

    /**
     * If assets.StdIn changes, use this to reinitialize the scanner.
     */
